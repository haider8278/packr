<div class="card-body">
    ...
    <div class="row mt-4 mb-4">
        <div class="col">
            ...
            <!--form-group-->
            <div class="form-group row">
                {{ Form::label('source', 'Source', ['class' => 'col-md-2 from-control-label required']) }}

                <div class="col-md-10">
                    {{ Form::text('source', null, ['class' => 'form-control', 'placeholder' => 'News Source', 'required' => 'required']) }}
                </div>
                <!--col-->
            </div>
            <!--form-group-->
            {{-- <div class="form-group row">
                {{ Form::label('political_spectrum', 'Political Spectrum', ['class' => 'col-md-2 from-control-label required']) }}

                <div class="col-md-10">
                    {{ Form::select('political_spectrum', ['L'=>'Left','LL'=>'Left Leaning','C'=>'Centrist','RL'=>'Right Leaning','R'=>'Right'], isset($blog) ? $blog->political_spectrum:'', ['class' => 'form-control categories box-size', 'placeholder' => 'Choose Political Spectrum', 'required' => 'required']) }}
                </div>
                <!--col-->
            </div> --}}
            <!--form-group-->
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-1">
                    <img src="{{ asset('images/'.$blog->featured_image) }}" height="80" width="80">
                </div>
                <div class="col-lg-5">
