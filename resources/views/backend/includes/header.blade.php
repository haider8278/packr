<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ asset('public/assets/images/logo.png') }}" style="height: 50px;" alt="ShipEarn">
        <img class="navbar-brand-minimized" src="{{ asset('public/assets/images/logo.png') }}" style="height: 50px;" alt="ShipEarn">
    </a>
