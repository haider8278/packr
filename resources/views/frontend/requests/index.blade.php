...
<div id="section-subheader1">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h3 class="clscheme">Requests/Offers</h3>
            </div>
            <div class="col-12">
                <form class="form-inline" action="" method="GET">
                    ...
                    <div class="row m-auto">
                        <div class="col">
                            ...
                            {{ Form::select('source', $countries, isset($_GET['source']) ? $_GET['source'] : '',['class' => 'form-control w-100', 'placeholder' => 'Travel From']) }}
                        </div>
                        <div class="col">
                            {{ Form::select('source', $countries, isset($_GET['destination']) ? $_GET['destination'] : '',['class' => 'form-control w-100', 'placeholder' => 'Travel To']) }}
                        </div>
                        <div class="col">
                            {{ Form::select('type', ['request'=>'want space','travel'=>'have space','shipping'=>'offer Shipping','particular'=>'offer Particular'], isset($_GET['type']) ? $_GET['type'] : '',['class' => 'form-control w-100', 'placeholder' => 'Select Type']) }}
                        </div>
                        <div class="col">
                            <button class="btn-1 shadow1 style3 bgscheme" type="submit" style="height: 38px;line-height: inherit;">Search</button>
                        </div>
                    </div>
...
<div id="section-bloglist1">
    <div class="container">
        <div class="row">
            ...
            <!-- Item -->
            <div class="offer-item item ez-animate col-sm-12 col-md-4 animated fadeInUp " data-animation="fadeInUp" style="animation-delay: 0s; opacity: 1;">
                ...
                <a href="{{route('frontend.requests.show',$post->slug)}}" class="bghoverscheme">
                    ...
                    <small class="text-muted">{{$post->created_at->diffForHumans()}} | Created By: {{$post->owner->first_name}} </small>
                    <p>{{$post->excerpt()}} </p>
                </a>
                </div>
            </div>
