...
<div id="section-subheader1">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h3 class="clscheme text-capitalize">Edit {{$post->type}}</h3>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="col">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                {{ Form::select('type', ['request'=>'I want space','travel'=>'I have space','shipping'=>'I offer Shipping','particular'=>'I offer Particular'], $post->type,['class' => 'form-control', 'placeholder' => 'Select Type']) }}
                            </div>
                            <!--col-->
                        </div>
                        <!--form-group-->
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                {{ Form::textarea('details', $post->details, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.access.posts.description')]) }}
                            </div>
                            <!--col-->
                        </div>
                        <!--form-group-->
