...
Route::group(['namespace' => 'Auth', 'as' => 'auth.'], function () {
    ...
    Route::group(['middleware' => 'guest'], function () {
        ...
        Route::post('signup', [RegisterController::class, 'registerStepOne'])->name('register.signup');
        Route::get('verify', [RegisterController::class, 'registerVerifyForm'])->name('register.verify');
        Route::post('verifycode', [RegisterController::class, 'registerVerifyCode'])->name('register.verifycode');
        Route::get('setpassword', [RegisterController::class, 'showSetPassword'])->name('register.setpasswordform');
        Route::post('setpassword', [RegisterController::class, 'setPassword'])->name('register.setpassword');
