...
class UserRepository extends BaseRepository
{
     ...
     * @return User
     */
    public function create(array $data,$profile_photo)
    {
        if($profile_photo){
     ...
     */
    public function update(User $user, array $data,$profile_photo)
    {
    ...
    protected function createUserStub($input)
    {
        ...
        $user->profile_photo = isset($input['profile_photo']) ? $input['profile_photo'] : '';
